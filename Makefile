...
dump1090: dump1090.o anet.o interactive.o mode_ac.o mode_s.o comm_b.o net_io.o crc.o demod_2400.o demod_2500.o stats.o cpr.o icao_filter.o track.o util.o convert.o ais_charset.o fir.o $(SDR_OBJ) $(COMPAT)
